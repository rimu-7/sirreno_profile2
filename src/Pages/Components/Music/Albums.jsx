...
const Albums = () => {
  ...
  useEffect(() => {
    const fetchMusic = async () => {
      try {
        const response = await fetch("https://profile-2-backend-server.vercel.app/api/album"); // Change this to your actual API endpoint
        if (!response.ok) {
  ...
  return (
    <div className="p-2">
      ...
      {loading && <p className="text-center text-gray-500">Loading Albums...</p>}
